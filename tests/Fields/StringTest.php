...
class StringTest extends AbstractFieldTestCase
{
    ...
    {
        $simpleString = new String();
        $minString = (new String())->minSize(5);
        $maxString = (new String())->maxSize(10);
        $sameMinMaxString = (new String())->minSize(5)->maxSize(5);
        $minMaxString = (new String())->minSize(5)->maxSize(10);
